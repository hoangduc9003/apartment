...
@section('title', __('labels.backend.contract.management') . ' | ' . __('labels.backend.contract.view'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">@lang('labels.backend.contract.view')</small>
                </h4>
            </div><!--col-->
        </div><!--row-->
        ...
        <div class="row mt-4 mb-4">
            <div class="col">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-expanded="true"><i class="fas fa-user"></i> @lang('labels.backend.contract.overview')</a>
                    </li>
                </ul>
                        ...
                        <div class="col">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        <th>@lang('labels.backend.apartment.number_of_contracts')</th>
                                        <td>{!! $apartment->number_of_contracts !!}</td>
                                    </tr>
